...
if(NOT WIN32)
	message(FATAL_ERROR "TestS6aDeleteSubscriberData.cmake currently supports Windows only")
endif()
...
execute_process(
	COMMAND "${S6A_DIAMETER_CLIENT_EXE}" 15 delete
	WORKING_DIRECTORY "${SOURCE_DIR}"
...
if(NOT SEND_RESULT EQUAL 0)
	message(FATAL_ERROR "Failed to send S6a CER+DSR: ${SEND_OUTPUT} ${SEND_ERROR}")
endif()
...
if(NOT CLI_OUTPUT MATCHES "Last Message[ ]*:[ ]+Delete-Subscriber-Data-Request \\(DSR\\)")
	message(FATAL_ERROR "Expected DSR as last message in CLI output. Output: ${CLI_OUTPUT}")
endif()
if(NOT CLI_OUTPUT MATCHES "Last Detail[ ]*:[ ]+imsi=001010123456789")
	message(FATAL_ERROR "Expected DSR imsi detail in CLI output. Output: ${CLI_OUTPUT}")
endif()
...
if(NOT LOG_CONTENT MATCHES "Parsed Diameter header from 127\\.0\\.0\\.1: command=Delete-Subscriber-Data-Request \\(DSR\\)")
	message(FATAL_ERROR "Missing DSR parse log entry")
endif()
if(NOT LOG_CONTENT MATCHES "Sent Diameter response to 127\\.0\\.0\\.1: command=Delete-Subscriber-Data-Answer \\(DSA\\)")
	message(FATAL_ERROR "Missing DSA response log entry")
endif()
