...
if(NOT WIN32)
	message(FATAL_ERROR "TestS6aAuth.cmake currently supports Windows only")
endif()
...
execute_process(
	COMMAND "${S6A_DIAMETER_CLIENT_EXE}" 15 auth
	WORKING_DIRECTORY "${SOURCE_DIR}"
...
if(NOT SEND_RESULT EQUAL 0)
	message(FATAL_ERROR "Failed to send S6a CER+AIR: ${SEND_OUTPUT} ${SEND_ERROR}")
endif()
...
if(NOT CLI_OUTPUT MATCHES "Last Message[ ]*:[ ]+Authentication-Information-Request \\(AIR\\)")
	message(FATAL_ERROR "Expected AIR as last message in CLI output. Output: ${CLI_OUTPUT}")
endif()
if(NOT CLI_OUTPUT MATCHES "Last Detail[ ]*:[ ]+imsi=001010123456789")
	message(FATAL_ERROR "Expected AIR imsi detail in CLI output. Output: ${CLI_OUTPUT}")
endif()
...
if(NOT LOG_CONTENT MATCHES "Parsed Diameter header from 127\\.0\\.0\\.1: command=Authentication-Information-Request \\(AIR\\)")
	message(FATAL_ERROR "Missing AIR parse log entry")
endif()
if(NOT LOG_CONTENT MATCHES "Sent Diameter response to 127\\.0\\.0\\.1: command=Authentication-Information-Answer \\(AIA\\)")
	message(FATAL_ERROR "Missing AIA response log entry")
endif()
