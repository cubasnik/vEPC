...
bool tryRoundTrip(const std::string& mode, std::string& error) {
    ...
    if (mode == "delete") {
        ...
        expectedMessageType = 0x1C;
        expectedTeid = 0x10004321u;
        expectedSequence = 0x4325;
    } else if (mode == "reject") {
        request = {
            0x32, 0x1D, 0x00, 0x23,
            0x10, 0x00, 0x43, 0x21,
        ...
        expectedMessageType = 0x1E;
        expectedTeid = 0x10004321u;
        expectedSequence = 0x4326;
        ...
        expectedMessageType = 0x23;
        expectedTeid = 0x10004321u;
        expectedSequence = 0x4327;
        ...
        expectedMessageType = 0x25;
        expectedTeid = 0x10004321u;
        expectedSequence = 0x4328;
        ...
        expectedMessageType = 0x31;
        expectedTeid = 0x10004321u;
        expectedSequence = 0x4329;
...
int main(int argc, char* argv[]) {
    ...
    if (mode != "create" && mode != "notify" && mode != "reject" && mode != "failure" && mode != "present" && mode != "identify" && mode != "activate" && mode != "update" && mode != "delete" && mode != "echo") {
